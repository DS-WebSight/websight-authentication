...
WebSight Authentication is a module responsible for logging in users in WebSight, maintaining authentications
history (dates of logins, logins counter, etc.), and providing all required views.
